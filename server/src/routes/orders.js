...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        `, [customerName, customerPhone, location, paymentMethod || 'Efectivo', deliveryTime, total, generalNote, status || 'new', userId, userName, req.body.discount || 0]);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        const { id } = req.params;
        const { status, paymentMethod, total, userName, userId, cxcCustomerId, cxcCustomerName, cxcCustomerPhone, discount } = req.body;
