      ...
      >
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          <div class="w-full max-w-md pt-10 mx-auto">
            <!-- Back to dashboard link removed/hidden as per typical admin auth flow -->
          </div>
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8">
                <h1
                  class="mb-2 font-semibold text-brand-500 text-title-sm dark:text-white/90 sm:text-title-md"
                >
                  Bienvenido
                </h1>
        ...
        <div
          class="relative items-center hidden w-full h-full lg:w-1/2 bg-gray-100 dark:bg-white/5 lg:grid"
        >
          <div class="flex items-center justify-center z-1">
            <common-grid-shape />
            <div class="flex flex-col items-center max-w-xs">
              <span class="block mb-4">
                <img width="231" height="48" src="/logo-bambu.png" alt="Logo" />
              </span>
              <p class="text-center text-brand-500 dark:text-white/60">
